...
import WeightSpaceVisualization from './components/WeightSpaceVisualization';
...
export default function SophisticatedPhase5Page() {
  ...
  // Render current sub-phase interface
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-orange-950 to-slate-950 text-white p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-xl text-gray-400">
          Multi-phase training with OpenRouter integration, weight space proprioception, and 10-level progression
        </p>
      </div>
      ...
      {!hasStarted ? (
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
          ...
          <div className="xl:col-span-1 space-y-4">
            ...
            {/* Weight Space Visualization - ALWAYS VISIBLE */}
            <WeightSpaceVisualization
              config={config}
              currentLevel={config.currentLevel}
            />
          </div>

          {/* Right Column: Sub-Phase Interfaces */}
          <div className="xl:col-span-3">
            {renderSubPhaseTabs()}

            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 min-h-[600px]">
              <div className="mb-4">
